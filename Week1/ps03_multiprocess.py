...
def make_coffee(customer_name, result_queue):
    ...
    sum(i * i for i in range(1000000)) # จำลองงานคำนวณ (CPU-bound) เล็กน้อย และรอ 5 วินาทีเต็ม
    sleep(5) # บล็อกการทำงานของ Thread ไว้ 5 วินาทีเต็ม
...
def main():
    ...
    for customer in queue:
        # สร้าง Process ใหม่ แยกจากกันโดยเด็ดขาด
    ...
    print(f"เวลาที่ CPU ใช้ประมวลผลจริง (Total CPU Time): {total_cpu_time:0.4f} วินาที")
