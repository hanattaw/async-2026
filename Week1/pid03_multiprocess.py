...
def make_coffee(customer_name):
    # ดึง PID ของระบบย่อยแต่ละคนนี้ (ซึ่งจะแตกกันทุกตัว)
    pid = os.getpid()
...
def main():
    ...
    print(f"{ctime()} | [Main PID: {main_pid}] [Main TID: {main_tid}] === เริ่มระบบจองคิวกาแฟแบบ Multi-processing ===")
    start_time = time()

    processes = []
    # ลูปการทำงาน process
    for customer in queue:
        # สร้าง Process ใหม่แยกออกจากตัวหลัก
