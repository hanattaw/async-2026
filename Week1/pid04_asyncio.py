...
async def make_coffee(customer_name):
    ...
    # ใน Python 3.12+ สามารถใช้หา Unique ID ของ Task ได้ง่ายผ่าน id(current_task)
...
async def main():
    ...
    print(f"{ctime()} | [Main PID: {main_pid}] [Main TID: {main_tid}] === เริ่มระบบจองคิวกาแฟแบบ asyncio ===")
    ...
    for customer in queue:
        ...
        # แปลง Coroutine ให้เป็น Task เพื่อให้ Event Loop บริหาร และสั่งรันได้
