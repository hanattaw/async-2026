...
async def main():
    ...
    # asyncio.gather fires items concurrently and collects into a single ordered list
    ...
    print(f"{ctime()} Execution Completed in: {time() - start:.2f} seconds") # Expected: ~1.00s
